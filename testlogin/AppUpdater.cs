...
namespace testlogin
{
	...
	public class AppUpdater:IDisposable
	{
		...
		public int CheckForUpdate(string serverXmlFile,string localXmlFile,out Hashtable updateFileList)
		{
			...
			XmlNodeList newNodeList = serverXmlFiles.GetNodeList("AutoUpdater/Updater/Files");
			XmlNodeList oldNodeList = localXmlFiles.GetNodeList("AutoUpdater/Updater/Files");
